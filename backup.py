...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(279, 397)
        Form.setWindowTitle("Backup & Restore Database Duta Parkir")
        ...
        self.button_backup = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.button_backup.setObjectName("button_backup")
        self.verticalLayout.addWidget(self.button_backup)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Folder Tujuan"))
        self.button_browser.setText(_translate("Form", "Browser"))
        self.button_backup.setText(_translate("Form", "Backup"))
